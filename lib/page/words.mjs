/*
  DECISION D5 - WORD BANDS, ENFORCED BY THE BUILD (decisions.md §8).
...
export const WORD_BANDS = Object.freeze({
  /* Halved on 2026-09-08 by owner decision (decisions.md change log): the
     first thirty-five cities read as essays, and the floors below keep the
     three-specific-sentences rule honest without demanding the essay. */
  city: [800, 1350],
  venue: [400, 700],
  county: [600, 1000],
  filter: [400, 700],
