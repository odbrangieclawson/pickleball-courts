...
const PLACEHOLDER_PHOTO = Object.freeze({
  ...
  /* LANDSCAPE source, 1600x977, cut from the 6000px original kept at the
     repo root as bg.jpg. Pexels photo under the Pexels licence: free for
     commercial use, no attribution required, so the caption carries none.
     These attributes must match the file or the reserved box is the wrong
     shape and the CLS work is undone. */
  width: 1600,
  height: 977,
  isPlaceholder: true,
