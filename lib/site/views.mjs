  ...
  return {
    ...
    */
    ...
    /*
      ...
      Washington leads this list because four of its cities have been
      verified, not because it out-plays Florida — Florida is bottom but
      one here and is, in reality, one of the densest pickleball states in
      the country. The heading and this sentence both say so, because a
      ranking with an honest label is useful and the same ranking with a
      dishonest one is a lie about the whole country.
    */
    statesNote:
      'Ranked by the courts we have verified, which measures our coverage rather than the states. '
      + 'Florida sits low on this list and is one of the busiest pickleball states in the country; '
      + 'we have simply verified one city of it so far.',
    states: stateCards(),
  }
}
