#!/usr/bin/env bash
# Snapshot a City of San Antonio page.
#
# www.sa.gov (OpenCities) refuses a bare curl with a 403 page under 500 bytes -
# intermittently: the same URL answered 200 to a bare curl minutes earlier. It serves the real document to a
